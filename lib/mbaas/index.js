...
function initRouter(mediator, userProfileExclusionList, expressSessionMiddleware) {
  ...
  router.route('/').get(function(req, res) {
    mediator.publish('wfm:user:list').then(function(data) {
  ...
  router.route('/:id').get(function(req, res) {
    ...
    // remove any sensitive fields from the user profile data, eg password.
    mediator.publish('wfm:user:read', userId).then(function(data) {
  ...
  router.route('/:id').put(function(req, res) {
    ...
    mediator.publish('wfm:user:update', user).then(function(saveduser) {
      res.json(saveduser);
    });
  });
  ...
  router.route('/').post(function(req, res) {
    ...
    mediator.publish('wfm:user:create', user).then(function(createduser) {
  ...
  router.route('/:id').delete(function(req, res) {
    ...
    mediator.publish('wfm:user:delete', user).then(function(deleted) {
      res.json(deleted);
    });
  });
