...
describe('Group Router Test', function() {
  ...
  it('should read an existing group', function(done) {
    ...
    mediator.once(CLOUD_DATA_TOPICS.read, function(uid) {
      ...
      return Promise.resolve(mockGroupList[0]);
    });
  ...
  it('should return the group that was created', function(done) {
    ...
    //Mock of the data topic subscriber in the storage module
    mediator.once(CLOUD_DATA_TOPICS.create, function(groupToCreate) {
  ...
  //
  //  //Mock of the data topic subscriber in the storage module
  //  mediator.once(CLOUD_DATA_TOPICS.delete, function(groupToDelete) {
  //    expect(groupToDelete).to.deep.equal(expectedGroupDeleted);
  ...
  //  //Mock of the data topic subscriber in the storage module
  //  mediator.once(CLOUD_DATA_TOPICS.delete, function(groupToDelete) {
  //    expect(groupToDelete).to.deep.equal(req);
